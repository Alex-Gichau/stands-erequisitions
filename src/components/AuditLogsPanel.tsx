...
export const AuditLogsPanel: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 bg-emerald-950/90 hover:bg-emerald-900 border-2 border-emerald-700/80 text-emerald-300 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-sm hover:shadow-md cursor-pointer group"
            title="Open Real-time Terminal Mode (100vh Low-Demand Virtualized Stream)"
          >
            <Terminal size={14} className="text-emerald-400 group-hover:animate-pulse" />
          </button>
          <button
      ...
      {/* Terminal View Mode Modal (100vh Virtualized Stream) */}
      <AuditLogsTerminalModal
        isOpen={showTerminal}
